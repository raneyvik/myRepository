...
public class RetailSiteApplicationTests {
	...
	public void testEmployeeSegmentDicount() {
		...
		retailSite.collectUserInfo(userBilder.firstName("Vikram").lastName("Raney").telephone("9739049080")
	...
	public void testPrintBillStatment() {
		...
		String expected = "User Details:[firstName=Vikram, lastName=Raney, telephone=9739049080, userType=OLD_CUSTOMER]Shop the following:[[itemName=Cat Food, itemCost=300.5, count=1, category=ANIMALS_FOOD], [itemName=Trouser, itemCost=100.0, count=1, category=CLOTHS], [itemName=Fruits, itemCost=50.0, count=1, category=GROCERIES], [itemName=RICE 10KG, itemCost=250.0, count=1, category=GROCERIES], [itemName=Tomoto 1KG, itemCost=20.0, count=1, category=GROCERIES], [itemName=Iphone 6 plus, itemCost=1200.999, count=1, category=ELECTRONICS], [itemName=wood, itemCost=0.5, count=1, category=OTHER], [itemName=Matt for BMW, itemCost=30.5, count=1, category=CAR_ACCESSORIES]] Total Bill Amount : 1952.499 Bill Amount After User Discount:1870.8740500000001 Bill Amount After final Discount:1780.8740500000001";
